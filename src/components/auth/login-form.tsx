...
import { login, loginWithProvider } from '@/lib/auth/actions'
...
export function LoginForm({ redirectTo, oauthError }: LoginFormProps) {
  ...
  async function handleGoogle() {
    ...
    else setError('Erreur de connexion Google')
  }
    ...
    <div className="space-y-7">
      ...
      <div className="animate-fade-up delay-100">
        <button
          ...
          disabled={isPending}
          className="w-full flex items-center justify-center gap-3 rounded-xl py-3 text-sm font-medium transition-all duration-200 hover:border-opacity-60 disabled:opacity-40"
          style={{
